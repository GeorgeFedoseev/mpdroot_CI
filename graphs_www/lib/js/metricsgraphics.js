...
(function () {
  ...
  function mg_add_line (args, plot, svg, existing_line, which_line, line_id) {
    if (!existing_line.empty()) {
      ...
      var custom_class = "";
      if(args.data[which_line][0].style != undefined){
        custom_class = args.data[which_line][0].style;
      }

      var this_path = svg.append('path')
        .attr('class', 'mg-main-line '+custom_class+'  mg-line' + line_id);

      //alert(this_path.attr('class'))
